...
export async function getPolygonData(date: string, sdk: Context): Promise<number> {
...
export default function registerPolygon(sdk: Context) {
  sdk.register({
    id: 'polygon',
    queries: {
      fees: (date: string) => getPolygonData(date, sdk),
    },
    metadata: {
      name: 'Polygon',
      category: 'l1',
