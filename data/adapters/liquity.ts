...
export default function registerLiquity(register: RegisterFunction) {
  ...
  register('liquity', query, {
    ...
    category: 'lending',
    description:
      'Liquity is a decentralized borrowing protocol that allows draw 0% interest loans against Ether.',
    feeDescription:
      'Borrowers pay fees when opening and closing positions, which are paid to LQTY stakers.',
